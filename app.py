...

{
    ...
    "resource_start": 0,
    "prompt": """\
VERSION: 33.0 | Сценарий: Управление проектом
...

{
    ...
    "resource_start": 0,
    "prompt": """\
VERSION: 33.0 | Сценарий: Межпланетная миссия
...

{
    ...
    "resource_start": 0,
    "prompt": """\
VERSION: 33.0 | Сценарий: Кризисное управление
...

{
    ...
    "resource_start": 0,
    "prompt": """\
VERSION: 33.0 | Сценарий: Разговор с информантом
...

{
    ...
    "resource_start": 1,
    "prompt": """\
VERSION: 33.0 | Сценарий: Борьба с вирусом
...

{
    ...
    "resource_start": 0,
    "prompt": """\
VERSION: 33.0 | Сценарий: Видеонаблюдение
...

{
    ...
    "resource_start": 0,
    "prompt": """\
VERSION: 33.0 | Сценарий: Поведение коллеги
...

{
    ...
    "resource_start": 0,
    "prompt": """\
VERSION: 33.0 | Сценарий: Клинические испытания
...

{
    ...
    "resource_start": 0,
    "prompt": """\
VERSION: 33.0 | Сценарий: Благоустройство
...

{
    ...
    "free_narrative": True,
    "prompt": """\
VERSION: 33.0 | Сценарий: Неопределённая задача: офис
...

{
    ...
    "free_narrative": True,
    "prompt": """\
VERSION: 33.0 | Сценарий: Неопределённая задача: сказка
...
def _generate_first_turn(session_state: dict) -> tuple:
    ...
    intro_user = (
        "Начни сценарий. Опиши исходную ситуацию коротко — строго в рамках того, "
        "что уже известно из описания роли. Не добавляй новых деталей, цифр, имён "
        "или конкретики которой нет в описании. Не давай советов и не предлагай "
        "вариантов действий. Заверши фразой: «Опишите ваше первое действие.»"
    )
    messages = [
